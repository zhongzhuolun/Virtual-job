...
async function requestSubscribeMessage(event) {
  ...
  return 'E5ZIimb6cnMxHRRAYLBei7dshRUcgbOYWAirbgGK_DY' // 如 'N_J6F05_bjhqd6zh2h1LHJ9TAv9IpkCiAJEpSw0PrmQ'
}
...
async function sendSubscribeMessage(event) {
  ...
  const sendResult = await cloud.openapi.subscribeMessage.send({
    touser: OPENID,
    templateId: 'E5ZIimb6cnMxHRRAYLBei7dshRUcgbOYWAirbgGK_DY',
